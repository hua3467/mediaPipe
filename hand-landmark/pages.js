const page_1 = `<header>
                <h1>Naton: Sip Into a Cool Summer</h1>
                </header>

                <section>
                <h2>Why Us</h2>
                <p>At Naton, we are the embodiment of all things green, organic, and the epitome of cool summer sips. Our commitment to crafting the finest, eco-friendly tea blends is unwavering. Why choose us? Because we believe that every sip should be a refreshing journey into the heart of nature, and our teas are the perfect companions for your organic, cool summer adventures.</p>
                </section>

                <section>
                <h2>Featured Products</h2>
                <h3>Refreshing Mint Burst</h3>
                <p>Description: Refreshing Mint Burst is a tea that invigorates your senses and revitalizes your spirit...</p>

                <h3>Tropical Mango Fusion</h3>
                <p>Description: Transport yourself to a tropical paradise with our Tropical Mango Fusion tea...</p>

                <h3>Citrus Sunrise Zest</h3>
                <p>Description: Start your day with a burst of sunshine with our Citrus Sunrise Zest tea...</p>
                </section>

                <section>
                <h2>Our Branding Stories</h2>
                <p><strong>The Organic Odyssey</strong>: Embark on an Organic Odyssey with Naton, where we source the finest organic tea leaves from lush, eco-friendly gardens...</p>
                <p><strong>From Nature's Lap to Your Cup</strong>: Discover the magic of pure, unadulterated flavor with Naton's dedication to preserving the essence of nature...</p>
                <p><strong>Cool Summer, Cool Choices</strong>: Cool summer vibes meet conscious choices at Naton...</p>
                </section>

                <section>
                <h2>Our Mission</h2>
                <p>At Naton, our mission is clear: to provide you with the purest, most refreshing organic tea experience, perfectly suited for the cool summer vibes you crave...</p>
                </section>
                <footer>
                        <p>Contact Us</p>
                        <p>Address: 123 Green Way, Organic Town, Coolsville</p>
                        <p>Phone: 555-555-5555</p>
                        <p>Email: info@naton.com</p>
                        <p>Follow Us: <a href="https://www.facebook.com/natonteas">Facebook</a> | <a href="https://www.instagram.com/natonteas">Instagram</a> | <a href="https://www.twitter.com/natonteas">Twitter</a></p>
                        <p>&copy; 2023 Naton Teas. All rights reserved.</p>
                    </footer>
                `

const page_2 = `<header>
                <h1>Naton Brand Stories</h1>
                </header>
...
const page_3 = `<header>
                <h1>Naton: Featured Products</h1>
                </header>

                <section>
                <h2>Product 1: Refreshing Mint Burst</h2>
                <p><strong>Description:</strong> Refreshing Mint Burst is a tea that invigorates your senses and revitalizes your spirit. This organic blend combines the crisp, cool taste of peppermint leaves with our high-quality green tea. The result is a refreshing infusion that's perfect for hot summer days.</p>
                ...
                <section>
                <h2>Product 2: Tropical Mango Fusion</h2>
                <p><strong>Description:</strong> Transport yourself to a tropical paradise with our Tropical Mango Fusion tea. This delightful blend combines the tropical sweetness of organic mango with the smooth, grassy notes of green tea. It's like a mini vacation in every sip.</p>
                ...
                <section>
                <h2>Product 3: Citrus Sunrise Zest</h2>
                <p><strong>Description:</strong> Start your day with a burst of sunshine with our Citrus Sunrise Zest tea. This lively blend combines the zing of organic citrus fruits, including orange and lemon, with the freshness of green tea. It's a vibrant and energizing choice for your morning ritual.</p>
